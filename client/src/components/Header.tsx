      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <div className="text-xl font-bold text-primary text-white">
              <span className="mr-1">한국문화예술교육진흥원</span>
              <span className="text-lg font-normal text-white-500"></span>
            </div>
          </div>
          ...
          <nav className="hidden md:flex space-x-6 text-sm">
            <Link href="#intro" onClick={closeMenu}>
              <a className="font-medium text-white hover:text-accent transition">
                소개
              </a>
            </Link>
        ...
        >
          <div className="flex flex-col space-y-3 text-sm">
            <a
              href="#intro"
              className="font-bold text-white hover:text-purple-600 transition"
              onClick={closeMenu}
            >
              소개
            </a>
